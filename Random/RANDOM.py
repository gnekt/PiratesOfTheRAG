...
if __name__ == "__main__":
    ...
    #         question_inj = question.values[0] + str(command)
    ...
    history = []
    stolen_chunks = 0
    questions_gpt = open("Random/questions_gpt.csv","r").readlines()
    ...
    for question in questions_gpt:
        ...
        batch["informations"]["chunks"] = contents
        history.append(batch)
        pickle.dump(history, open(f"{SavePath}/gpt/history.pkl", "wb"))
